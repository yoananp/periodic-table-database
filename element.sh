...
echo "The element with atomic number $ATOMIC_NUMBER is $NAME ($SYMBOL). It's a $TYPE, with a mass of $MASS amu. $NAME has melting point of $MELTING celsius and a boiling point of $BOILING celsius."
